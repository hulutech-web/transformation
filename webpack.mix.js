...
mix.js('admin/main.js', 'public/admin/dist')
    .vue()
    .postCss('admin/css/main.css', 'public/admin/dist', [require('postcss-import'), require('autoprefixer')])
    .webpackConfig(require('./webpack.config'))
    // .webpackConfig({
    //     plugins: [new BundleAnalyzerPlugin()]
    // })
    .extract(['vue', 'vuex', 'lodash', 'vue-router', 'moment', 'mammoth', 'echarts', 'v-charts', 'vue-esign', 'vue-cropper'])
