<template>
  <div class="quarter-component" id="contextMenuBox">
    <li @click="toggleMenu()" class="dropdown-toggle" v-if="options.year !== undefined">
    ...
    <ul class="quarter" :class="{ hide: !showMenu }">
      ...
      <li class="quarter-item" :class="{ cur: 1 === options.quarter }"
          @click="options.year <= max && handleQuarterSelect(1)">
        第一季度
      </li>
      <li class="quarter-item" :class="{ cur: 2 === options.quarter }"
          @click="options.year <= max && handleQuarterSelect(2)">
        第二季度
      </li>
      <li class="quarter-item" :class="{ cur: 3 === options.quarter }"
          @click="options.year <= max && handleQuarterSelect(3)">
        第三季度
      </li>
      <li class="quarter-item" :class="{ cur: 4 === options.quarter }"
...
.quarter-component {
  ...
  &:hover {
    transation: all opacity 0.5s ease;
